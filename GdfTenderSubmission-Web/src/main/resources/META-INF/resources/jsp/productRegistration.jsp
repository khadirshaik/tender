<portlet:resourceURL id="saveProductsRegistration" var="saveProductsRegistration" />
<portlet:resourceURL id="tenderSubmissionNext" var="tenderSubmissionNext" />
<portlet:resourceURL id="fetchDeadLineDateDetails" var="fetchDeadLineDateDetails" />
		...
		<div class="row text-center">
			<div class="btnWrapperCenter">
				...
				<button type="button" class="btn btn-save"
					onclick="saveProductsRegistration('<%=saveProductsRegistration.toString()%>')">Save</button>
				<button class="btn btn-nxt nextBtnTab1" type="button" onclick="fetchDeadLineDateDetails('<%=fetchDeadLineDateDetails.toString()%>')"
