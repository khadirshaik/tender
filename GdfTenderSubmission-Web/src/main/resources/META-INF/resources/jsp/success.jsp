			...
			<div class="container">
				...
				<div class=" text-center successBox">
					<div class="row">
						...
						<div>
							<p> "Thank You! You have successfully submitted your
								Technical Bid for eligible products for the GDF tender with
								reference number <strong><%=renderRequest.getAttribute("tenderReferenceNumber")%></strong>
								. A notification email has been sent to your email address to
