...
<portlet:resourceURL id="editPrdRegDetails" var="editPrdRegDetails" />
		...
		<div class="row text-center">
			<div class="btnWrapperCenter">
				...
				<button type="button" class="btn btn-save" id="savebtn"
					onclick="editAlreadySelectedProducts('<%=alreadySelectedProducts.toString()%>')">Save</button>
				<button class="btn btn-nxt nextBtnTab1" type="button"
					onclick="editPrdRegDetails('<%=editPrdRegDetails.toString()%>')"
