  ...
  $.fn.multifile = function(containerOrAttributes, templateCb)
  {
    ...
    var $container
      , addInput = function(event)
        {
    	 var flag_validFile = false;

       /*  if($(this)[0].files.length>0)
         {
         var selectedFile = $(this)[0].files[0];
         if(selectedFile.type.indexOf("jpg") >=0 || selectedFile.type.indexOf("png") >= 0 || selectedFile.type.indexOf("jpeg") >= 0 || selectedFile.type.indexOf("image") >= 0 ){
                    flag_validFile = true; 
                    console.log('In');
         }
         }*/

       /*  if(flag_validFile == false)
         {
        	// $('.paymentup').text("Incorrect file format");
       //   $('.paymentup').show();
          console.log('Show');
          return;
         }*/
      ...
      , bindRemoveInput = function($input)
        {
          ...
          return function(event)
          {
           ...
           // $('#fileformatval').attr('style', 'display:none');
