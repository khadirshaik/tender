...
/**
 * Provides the local service interface for GDFTenderScheduleItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author KS61374
 * @see GDFTenderScheduleItemLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GDFTenderScheduleItemLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GDFTenderScheduleItemLocalServiceUtil} to access the gdf tender schedule item local service. Add custom service methods to <code>com.gdf.technical.bids.service.impl.GDFTenderScheduleItemLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GDFTenderScheduleItem>
