...
/**
 * Provides the local service interface for GDFTenderSubFPPMatDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author KS61374
 * @see GDFTenderSubFPPMatDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GDFTenderSubFPPMatDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GDFTenderSubFPPMatDetailsLocalServiceUtil} to access the gdf tender sub fpp mat details local service. Add custom service methods to <code>com.gdf.technical.bids.service.impl.GDFTenderSubFPPMatDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GDFTenderSubFPPMatDetails>
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GDFTenderSubFPPMatDetails>
		getGDFTenderFPPMartDetailsBySelectedStatus(boolean fppSelectedStatus);
